...
### 1.3 P2 增量配置（如有）
| 品类 | 目标占比 | 当前占比 | 缺口金额(¥) | 期望特征标签 | 推荐基金 |
|------|---------|---------|------------|-------------|---------|
| `<category>` | `<x%>` | `<y%>` | `<+z>` | 「`<tag1>`」「`<tag2>`」 | `<code>` `<name>` |
| ... | ... | ... | ... | ... | ... |

### 1.4 P3 维持当前（如有）
| 代码 | 名称 | 当前净值 | 金额(¥) | 机会要点 | 风险提示 |
|------|------|---------|---------|---------|---------|
| `<code>` | `<name>` | `<unit_nav>` | `<amount>` | `<具体机会描述>` | `<具体风险描述>` |
| ... | ... | ... | ... | ... | ... |
