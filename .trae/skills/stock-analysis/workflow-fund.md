...
[Step 2] 主对话智能增量拉取数据
    ↓
[Step 3] 7 基金分析师 subagent 并行 → 7 份报告
    ↓
[Step 4] 主对话收集报告 + 数据源评估
    ↓
[Step 5] 多头 + 空头 subagent 并行辩论
    ↓
[Step 6] research-manager subagent → 投资计划
    ↓
[Step 7] trader subagent → 交易方案
    ↓
[Step 8] 激进 + 保守 风控 subagent 并行 → 中立裁决
    ↓
[Step 9] portfolio-manager subagent → 最终报告
    ↓
[Step 10] 主对话渲染 HTML → 保存
```
